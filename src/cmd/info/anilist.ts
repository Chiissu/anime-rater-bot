import { ChatInputCommandInteraction, CommandInteractionOptionResolver, EmbedBuilder, SlashCommandSubcommandBuilder } from "discord.js";
...
function command(subcmd: SlashCommandSubcommandBuilder) {
  return subcmd
    .setName("anilist")
    .setDescription("Quickly get Anilist information about an anime")
